...
import 'package:cea_zed/application/new_ui/new_ui_bloc.dart';
...
import 'package:cea_zed/presentation/components/button/filter_button.dart';
...
import 'package:cea_zed/presentation/pages/products/widgets/cart_button.dart';
import 'package:cea_zed/presentation/pages/products/widgets/new_scrollable_ui.dart';
import 'package:cea_zed/presentation/pages/products/widgets/simple_list_page.dart';
    ...
    return AppBar(
      ...
      title: Row(
        children: [
          ...
          12.horizontalSpace,
          Text(
            "${state.totalCount} ${AppHelper.getTrn(TrKeys.products)}",
