...
MyMembershipResponse myMembershipResponseFromJson(String str) =>
    MyMembershipResponse.fromJson(json.decode(str));

String myMembershipResponseToJson(MyMembershipResponse data) =>
...
class MyMembershipResponse {
  ...
  factory MyMembershipResponse.fromJson(Map<String, dynamic> json) =>
      MyMembershipResponse(
        data: json["data"] == null
            ? []
            : List<MyMembershipModel>.from(
                json["data"]!.map((x) => MyMembershipModel.fromJson(x))),
      );
  ...
  factory MyMembershipModel.fromJson(Map<String, dynamic> json) {
    return MyMembershipModel(
      ...
      memberShip: json["member_ship"] == null
          ? null
          : MembershipModel.fromJson(json["member_ship"]),
    );
  }
